...
$_LANG['accountinfo'] = "ანგარიშის ინფორმაცია";
$_LANG['accountstats'] = "ანგარიშის სტატისტიკა";
$_LANG['addfunds'] = "თანხის დამატება";
$_LANG['addfundsamount'] = "თანხა";
$_LANG['addfundsmaximum'] = "მაქს. თანხა";
$_LANG['addfundsmaximumbalance'] = "მაქს. ბალანსი";
$_LANG['addfundsmaximumbalanceerror'] = "ბალანსის მაქს. რაოდენობა არის";
$_LANG['addfundsmaximumerror'] = "დეპოზიტის მაქს. რაოდენობა არის";
$_LANG['addfundsminimum'] = "მინ. დეპოზიტი";
$_LANG['addfundsminimumerror'] = "დეპოზიტის მინ. რაოდენობა";
$_LANG['addmore'] = "დამატება";
$_LANG['addtocart'] = "კალათაში დამატება";
$_LANG['affiliatesactivate'] = "პარტნიორული პროგ. აქტივაცია";
$_LANG['affiliatesamount'] = "რაოდენობა";
$_LANG['affiliatesbalance'] = "მიმდინარე ბალანსი";
...
$_LANG['affiliatescommission'] = "კომისია";
$_LANG['affiliatesdescription'] = "ჩაერთე პარტნიორულ პროგრამაში ან იხილე მონაგარი";
$_LANG['affiliatesdisabled'] = "ამ დროისთვის პარტნიორული პროგრამა შეჩერებულია.";
$_LANG['affiliatesearn'] = "გამომუშავება";
...
$_LANG['affiliatesreferallink'] = "უნიკალური რეფერალური ბმული";
$_LANG['affiliatesreferals'] = "რეფერალები";
$_LANG['affiliatesregdate'] = "რეგისტრაციის დრო";
...
$_LANG['announcementsdescription'] = "ნახეთ სიახლეები და ჩვენი განაცხედები";
$_LANG['announcementsnone'] = "განაცხადები არ გვაქვს";

$_LANG['announcementsrss'] = "იხილეთ RSS";
$_LANG['announcementstitle'] = "სიახლეები";
...
$_LANG['bannedtitle'] = "IP ბლოკირებულია";
$_LANG['bannedyourip'] = "თქვენი IP";
$_LANG['cartaddons'] = "დანამატები";
...
$_LANG['cartconfigserver'] = "სერვერის კონფიგურაცია";
$_LANG['cartcustomfieldsdesc'] = "მოცემული პროდუქტით/სერვისით სარგებლობისთვის თქვენგან დამატებითი ინფორმაცია მოითხოვება.";
$_LANG['cartdomainsconfig'] = "დომეინების კონფიგურაცია";
...
$_LANG['carteditproductconfig'] = "კონფიგურაციის რედაქტირება";
$_LANG['cartempty'] = "თქვენი კალათა ცარიელია.";
$_LANG['cartemptyconfirm'] = "ნამდვილად გსურთ კალათის გასუფთავება?";
$_LANG['cartexistingclientlogin'] = "არსებული მომხმარებლის ";
...
$_LANG['cartproductdomainchoose'] = "დომეინის არჩევა";
...
$_LANG['checkavailability'] = "ხელმისაწვდომობის შემოწმება";
$_LANG['checkout'] = "შეკვეთა";
$_LANG['choosecurrency'] = "ვალუტის არჩევა";
$_LANG['choosedomains'] = "დომეინის არჩევა";
$_LANG['clickheretologin'] = "შესვლისთვის აქ დააჭირეთ";
...
$_LANG['clientareacancelproduct'] = "გაუქმების მოთხოვნა";
$_LANG['clientareacancelreason'] = "მოთხოვნის მიზეზის მოკლე აღწერა";
...
$_LANG['clientareachoosecontact'] = "აირჩიეთ კონტაქტ";
...
$_LANG['clientareacontactsemails'] = "ელ.ფოსტის უპირატესობები";
...
$_LANG['clientareacountry'] = "ქვეყანა";
$_LANG['clientareacurrentsecurityanswer'] = "შეიყვანეთ არსებული პასუხი";
$_LANG['clientareacurrentsecurityquestion'] = "აირჩიეთ კითხვა უსაფრთხოებისათვის";
$_LANG['clientareadeletecontact'] = "კონტაქტის წაშლა";
$_LANG['clientareadeletecontactareyousure'] = "ნამდვილად გსურთ ამ კონტაქტის წაშლა?";
$_LANG['clientareadescription'] = "იხილეთ და განახლეთ თქვენი ანგარიშის მონაცემები";
$_LANG['clientareadisklimit'] = "დისკის ლიმიტი";
$_LANG['clientareadiskusage'] = "გამოყენებული დისკური სივრცე";
$_LANG['clientareadomainexpirydate'] = "გაუქმების თარიღი";
$_LANG['clientareadomainnone'] = "დომენები არაა რეგისტრირებული";
$_LANG['clientareaemail'] = "ელ. ფოსტა";
$_LANG['clientareaemails'] = "ჩემი წერილები";
$_LANG['clientareaemailsdate'] = "გაგზავნის დრო";
$_LANG['clientareaemailsintrotext'] = "ქვემოთ მოყვანილია ჩვენ მიერ გაგზავნილი შეტყობინებების ისტორია. ეს გეხმარებათ თავიდანვე იხილოთ ყველა თქვენს ანგარიშზე გამოგზავნილი ინფორმაცია მათი დაკარგვისას.";
$_LANG['clientareaemailssubject'] = "შეტყობინების თემა";
$_LANG['clientareaerroraddress1'] = "თქვენ არ შეგიყვანიათ მისამართი (ველი 1)";
$_LANG['clientareaerroraddress12'] = "თქვენი მისამართე შეიძლება შეიცავდეს მხოლოდ ციფრებსა და ასოებს";
$_LANG['clientareaerrorbannedemail'] = "მოცემულ ელ.ფოსტის პროვაიდერის მომხმარებელს არ ვრთავთ ნებას ისარგებლონ ჩვენი სერვისით. გთხოვთ, შეცვალოთ ელ.ფოსტა.";
$_LANG['clientareaerrorcity'] = "არ შეგიყვანიათ ქალაქის დასახელება";
$_LANG['clientareaerrorcity2'] = "ქალაქის დასახელება უნდა შეიცავდეს მხოლოდ ასოებს.";
$_LANG['clientareaerrorcountry'] = "აირჩიეთ თქვენი ქვეყანა ჩამოსაშლელი მენიუდან";
$_LANG['clientareaerroremail'] = "არ შეგიყვანიათ ელ.ფოსტის მისამართი";
$_LANG['clientareaerroremailinvalid'] = "თქვენი ელ.ფოსტა არასწორია";
$_LANG['clientareaerrorfirstname'] = "არ შეგიყვანიათ თქვენი სახელი";
$_LANG['clientareaerrorfirstname2'] = "თქვენი სახელი უნდა შეიცავდეს მხოლოდ ასოებს";
$_LANG['clientareaerrorisrequired'] = "მოითხოვება";
$_LANG['clientareaerrorlastname'] = "არ შეგიყვანიათ მხოლოდ თქვენი გვარი";
$_LANG['clientareaerrorlastname2'] = "თქვენი გვარი უნდა შეიცავდეს მხოლოდ ასოებს";
$_LANG['clientareaerroroccured'] = "დაფიქსირდა შეცდომა, სცადეთ მოგვიანებით.";
$_LANG['clientareaerrorpasswordconfirm'] = "პაროლი არ დაგიდასტურებიათ";
$_LANG['clientareaerrorpasswordnotmatch'] = "შეყვანილი პაროლები ერთმანეთს არ ემთხვევა";
...
$_LANG['clientareafirstname'] = "სახელი";
$_LANG['clientareafraud'] = "Fraud";
$_LANG['clientareafullname'] = "მომხმარებლის სახელი";
...
$_LANG['clientareahostingaddons'] = "დანამატები";
$_LANG['clientareahostingaddonsintro'] = "თქვენ გაქვთ შემდეგი დამანამტები ამ პროდუქტისთვის.";
...
$_LANG['clientareanavdomains'] = "ჩემი დომეინები";
$_LANG['clientareanavhome'] = "მთავარი";
$_LANG['clientareanavlogout'] = "გამოსვლა";
...
$_LANG['clientareaphonenumber'] = "ტელ. ნომერი";
$_LANG['clientareapostcode'] = "საფოსტო ინდექსი";
$_LANG['clientareaproductdetails'] = "პროდუქტის მონაცემები";
$_LANG['clientareaproducts'] = "ჩემი პროდუქტები &amp; სერვისები";
$_LANG['clientareaproductsnone'] = "No Products/Services Ordered";
$_LANG['clientarearegistrationperiod'] = "Registration Period";
$_LANG['clientareasavechanges'] = "ცვლილებების შენახვა";
...
$_LANG['clientareastate'] = "შტატი/რეგიონი";
$_LANG['clientareastatus'] = "სტატუსი";
$_LANG['clientareasuspended'] = "შეჩერებული";
$_LANG['clientareaterminated'] = "წაშლილი";
$_LANG['clientareaticktoenable'] = "ჩასართავად მონიშნე";
$_LANG['clientareatitle'] = "მომხმარებლის გვერდი";
$_LANG['clientareaunlimited'] = "ულიმიტო";
...
$_LANG['clientregistertitle'] = "რეგისტრაცია";
$_LANG['clientregisterverify'] = "რეგისტრაციის შემოწმება";
...
$_LANG['closewindow'] = "ფანჯრის დახურვა";
$_LANG['completeorder'] = "შეკვეთის დასრულება";
$_LANG['confirmnewpassword'] = "ახალი პაროლის დადასტურება";
$_LANG['contactemail'] = "ელ. ფოსტა";
$_LANG['contacterrormessage'] = "წერილისთვის განკუთვნილი სივრცე ცარიელია";
$_LANG['contacterrorname'] = "არ მიგითითებიან თქვენი სახელი";
$_LANG['contacterrorsubject'] = "არ მიგითებიათ წერილის საგანი";
$_LANG['contactheader'] = "თუკი გაქვთ შეკითხვები ან გარკვეული მიზეზით გსურთ ჩვენთან დაკავშირება - გამოიყენეთ ქვემოთ მოცემული ფორმა. ";
$_LANG['contactmessage'] = "შეტყობინება";
$_LANG['contactname'] = "სახელი";
...
$_LANG['creditcardcardnumber'] = "ბარათის ნომერი";
$_LANG['creditcardcardstart'] = "Start Date";
$_LANG['creditcardcardtype'] = "ბარათის ტიპი";
...
$_LANG['creditcardcvvwhere'] = "სად შემიძლია ვიპოვე ეს?";
$_LANG['creditcarddeclined'] = "თქვენი ბარათის მონაცემები უარყოფილია. სცადეთ სხვა ბარათი ან დაუკავშირდით ტექ.დახმა";
$_LANG['creditcarddetails'] = "საკრედიტო ბარათის მონაცემები";
$_LANG['creditcardenterexpirydate'] = "არ მიგითითებიათ ბარათის ვარგისიანობის თარიღი";
$_LANG['creditcardenternewcard'] = "შეიყვანეთ ახალი ბარათის მონაცემები";
$_LANG['creditcardenternumber'] = "არ მიგითითებიათ საკრედიტო ბარათის ნომერი";
$_LANG['creditcardinvalid'] = "საკრედიტო ბარათის მონაცემები არასწორია. სცადეთ სხვა ბარათი ან დაუკავშირდით ჰოსტინგის დახმარების ცენტრს.";
$_LANG['creditcardnumberinvalid'] = "საკრედიტო ბარათის ნომერი არასწორია.";
$_LANG['creditcardsecuritynotice'] = "თქვენ მიერ შეყვანილი ინფორმაცია დაშიფრულია და დაცულია თაღლითების მავნე ხელისგან.";
$_LANG['creditcarduseexisting'] = "არსებული ბარათის გამოყენება";
$_LANG['customfieldvalidationerror'] = "მნიშვნელობა არასწორია";
$_LANG['days'] = "დღე"; #არ შეიცვალოს რადგან ქართულში დღეების რაოდენობის შემდეგ "დღე" მხოლობითშია
$_LANG['defaultbillingcontact'] = "Default Billing Contact";
$_LANG['domainalternatives'] = "სცადეთ მოცემული ალტერნატივები:";
$_LANG['domainavailable'] = "ხელმისაწვდომია! ახლავე შეუკვეთეთ";
$_LANG['domainavailable1'] = "გილოცავთ!";
$_LANG['domainavailable2'] = "ხელმისაწვდომია!";
$_LANG['domainavailableexplanation'] = "დომეინს დასარეგისტირებლად დააჭირეთ ლინკს";
...
$_LANG['domaincheckerdescription'] = "შეამოწმეთ დომეინის ხელმისაწვდომობა";
$_LANG['domaincontactinfo'] = "საკონტაქტო ინფორმაცია";
$_LANG['domaincurrentrenewaldate'] = "Current Renewal Date";
$_LANG['domaindnsaddress'] = "მისამართი";
$_LANG['domaindnshostname'] = "Host Name";
$_LANG['domaindnsmanagement'] = "DNS მართვა";
...
$_LANG['domainemailforwardingprefix'] = "პრეფიქსი";
$_LANG['domaineppcode'] = "EPP კოდი";
...
$_LANG['domaingeteppcode'] = "EPP კოდის მიღება";
...
$_LANG['domainidprotection'] = "ID დაცვა";
...
$_LANG['domainlookupbutton'] = "მოძებნა";
$_LANG['domainmanagementtools'] = "სამართავი ხელსაწყოები";
$_LANG['domainminyears'] = "Min. Years";
$_LANG['domainmoreinfo'] = "მეტი ინფორმაცია";
$_LANG['domainname'] = "დომეინის სახელწოდება";
...
$_LANG['domainordernow'] = "ახლავე შეუკვეთე!";
$_LANG['domainorderrenew'] = "Order Renewal";
$_LANG['domainprice'] = "ფასი";
$_LANG['domainregisterns'] = "NameServers რეგისტრაცია";
$_LANG['domainregisternscurrentip'] = "მიმდინარე IP მისამართი";
$_LANG['domainregisternsdel'] = "NameServer წაშლა";
...
$_LANG['domainregisternsip'] = "IP მისამართი";
$_LANG['domainregisternsmod'] = "NameServer-ის IP შეცვლა";
$_LANG['domainregisternsmodsuccess'] = "The nameserver  was successfully modified";
$_LANG['domainregisternsnewip'] = "ახალი IP მისამართი";
...
$_LANG['domainrenew'] = "დროის გახანგრძლივება";
...
$_LANG['domainsautorenew'] = "ავტომატური განახლება";
$_LANG['domainsautorenewdisable'] = "ავტომატური განხლების გამორთვა";
$_LANG['domainsautorenewdisabled'] = "გამორთულია";
$_LANG['domainsautorenewdisabledwarning'] = "გაფრთხილება! ამ დომეინისთვის ავტომატური განახლება გამორთულია.<br />It will therefore expire and become inactive at the end of the current term unless manually renewed.";
$_LANG['domainsautorenewenable'] = "Enable Auto Renew";
$_LANG['domainsautorenewenabled'] = "Enabled";
$_LANG['domainsautorenewstatus'] = "ამჟამინდელი სტატუსი";
$_LANG['domainsimplesearch'] = "Simple Domain Search";
$_LANG['domainspricing'] = "Domain Pricing";
$_LANG['domainsregister'] = "რეგისტრაცია";
$_LANG['domainsrenew'] = "Renew";
$_LANG['domainsrenewnow'] = "Renew Now";
$_LANG['domainstatus'] = "სტატუსი";
$_LANG['domainstransfer'] = "Transfer";
$_LANG['domaintitle'] = "Domain Checker";
$_LANG['domaintld'] = "TLD";
$_LANG['domaintransfer'] = "Domain Transfer";
$_LANG['domainunavailable'] = "ხელმიუწვდომელია";
$_LANG['domainunavailable1'] = "ვწუხვართ!";
$_LANG['domainunavailable2'] = "უკვე დაკავებულია!";
$_LANG['domainreserved'] = "დაჯავშნულია";
$_LANG['domainreserved1'] = "Domain";
$_LANG['domainreserved2'] = "is available, but reserved.";
$_LANG['domainviewwhois'] = "view whois report";
$_LANG['downloaddescription'] = "აღწერა";
...
$_LANG['existingpasswordincorrect'] = "თქვენ არასწორად შეიყვანეთ ამჟამინდელი პაროლი.";
...
$_LANG['invoices'] = "ჩემი ინვოისები";
$_LANG['invoicesamount'] = "ოდენობა";
$_LANG['invoicesattn'] = "ATTN";
$_LANG['invoicesbacktoclientarea'] = "&laquo; მომხმარებლის არეში დაბრუნება";
$_LANG['invoicesbalance'] = "ბალანსი";
$_LANG['invoicesbefore'] = "before";
$_LANG['invoicescancelled'] = "გაუქმებული";
$_LANG['invoicescollections'] = "Collections";
$_LANG['invoicescredit'] = "კრედიტი";
$_LANG['invoicesdatecreated'] = "Invoice Date";
$_LANG['invoicesdatedue'] = "გადახდის თარიღი";
$_LANG['invoicesdescription'] = "აღწერა";
...
$_LANG['invoicesnoinvoices'] = "ინვოისები არ არის";
$_LANG['invoicesnotes'] = "ჩანაწერები";
$_LANG['invoicesoutstandinginvoices'] = "გადაუხდელი ინვოისები";
$_LANG['invoicespaid'] = "გადახდილია";
$_LANG['invoicespaynow'] = "ახლავე გადაიხადეთ";
$_LANG['invoicespayto'] = "Pay To";
$_LANG['invoicesrefunded'] = "ანაზღაურებულია";
$_LANG['invoicesstatus'] = "სტატუსი";
$_LANG['invoicessubtotal'] = "Sub Total";
$_LANG['invoicestax'] = "Tax Due";
$_LANG['invoicestaxindicator'] = "Indicates a taxed item.";
$_LANG['invoicestitle'] = "ინვოისი #";
$_LANG['invoicestotal'] = "Total";
$_LANG['invoicestransactions'] = "ტრანზაქციები";
$_LANG['invoicestransamount'] = "ოდენობა";
$_LANG['invoicestransdate'] = "ტრანზაქციის თარიღი";
$_LANG['invoicestransgateway'] = "Gateway";
$_LANG['invoicestransid'] = "ტრანაქციის ID";
$_LANG['invoicestransnonefound'] = "No Related Transactions Found";
$_LANG['invoicesunpaid'] = "გადაუხდელია";
$_LANG['invoicesdraft'] = "Draft";
$_LANG['invoicesview'] = "ინვოისის ნახვა";
...
$_LANG['knowledgebasearticles'] = "სტატიები";
$_LANG['knowledgebasecategories'] = "კატეგორიები";
$_LANG['knowledgebasedescription'] = "Browse our KB for answers to FAQs";
$_LANG['knowledgebasefavorites'] = "ფავორიტებში დამატება";
$_LANG['knowledgebasehelpful'] = "იყო კი ეს პასუხი დამაკმაყოფილებელი?";
$_LANG['knowledgebaseintrotext'] = "ცოდნის ბაზა რამდენიმე კატეგორიადაა დაყოფილი. ან კატეგორია აირჩიეთ ან მოძებნეთ შესატყვისი სიტყვებით თქვენს სასურველს კითხვაზე პასუხი";
$_LANG['knowledgebasemore'] = "იხილეთ მეტი";
$_LANG['knowledgebaseno'] = "არა";
$_LANG['knowledgebasenoarticles'] = "სტატიები არ მოიძებნა";
$_LANG['knowledgebasenorelated'] = "There are no Related Articles";
$_LANG['knowledgebasepopular'] = "ყველაზე პოპულარული სტატიები";
$_LANG['knowledgebaseprint'] = "სტატიის ამობეჭვდა";
$_LANG['knowledgebaserating'] = "რეიტინგი:";
$_LANG['knowledgebaseratingtext'] = "მოხმარებელს სტატია გამოადგა";
$_LANG['knowledgebaserelated'] = "Related Articles";
$_LANG['knowledgebasesearch'] = "ძებნა";
$_LANG['knowledgebasetitle'] = "ცოდნის ბაზა";
$_LANG['knowledgebaseviews'] = "ნახვები";
$_LANG['knowledgebasevote'] = "ხმის მიცემა";
$_LANG['knowledgebasevotes'] = "ხმები";
$_LANG['knowledgebaseyes'] = "დიახ";
$_LANG['knowledgebaseArticleRatingThanks'] = "მადლობა სტატიის შეფასებისთვის";
$_LANG['language'] = "ენა";
$_LANG['latefee'] = "Late Fee";
$_LANG['latefeeadded'] = "დამატებულია";
$_LANG['latestannouncements'] = "განცხადებები";
$_LANG['loginbutton'] = "ავტორიზაცია";
$_LANG['loginemail'] = "ელ.ფოსტის მისამართი";
$_LANG['loginforgotten'] = "დაგავიწყდათ პაროლი?";
...
$_LANG['loginpassword'] = "პაროლი";
$_LANG['loginrememberme'] = "დამიმახსოვრე";
$_LANG['logoutcontinuetext'] = "გასაგრძელებლად აქ დააწკაპუნეთ..."; #დააწკაპუნეთ თუ დააკლიკეთ?
$_LANG['logoutsuccessful'] = "თქვენ წარმატებით გამოხვედით სისტემიდან..";
$_LANG['logouttitle'] = "გამოსვლა";
$_LANG['maxmind_anonproxy'] = "პროქსი სერვერით მოსარგებლეთა შეკვეთა ავტომატურად უქმდება";
...
$_LANG['maxmind_incorrectcode'] = "კოდი არასწორია";
...
$_LANG['more'] = "მეტი";
$_LANG['morechoices'] = "მეტი არჩევანი";
...
$_LANG['networkissuesdate'] = "თარიღი";
...
$_LANG['networkissuespriority'] = "პრიორიტეტი";
$_LANG['networkissuesprioritycritical'] = "კრიტიკული";
$_LANG['networkissuespriorityhigh'] = "მაღალი";
$_LANG['networkissuesprioritylow'] = "დაბალი";
...
$_LANG['orderavailable'] = "ხელმისაწვდომი";
$_LANG['orderavailableaddons'] = "Click to view available addons";
$_LANG['orderbillingcycle'] = "Billing Cycle";
$_LANG['ordercategories'] = "კატეგორიები";
$_LANG['orderchangeaddons'] = "Change Addons";
$_LANG['orderchangeconfig'] = "Change Configurable Options";
$_LANG['orderchangedomain'] = "დომეინის შეცვლა";
$_LANG['orderchangenameservers'] = "nameserver შეცვლა";
$_LANG['orderchangeproduct'] = "პროდუქტის შეცვლა";
$_LANG['ordercheckout'] = "შეკვეთა";
...
$_LANG['orderconfirmation'] = "შეკვეთის დადასტურება";
$_LANG['orderconfirmorder'] = "შეკვეთის დადასტურება";
$_LANG['ordercontinuebutton'] = "გასაგრძელებლად დააკლიკეთ >>";
$_LANG['orderdesc'] = "აღწერა";
$_LANG['orderdescription'] = "Place a new order with us";
$_LANG['orderdiscount'] = "ფასდაკლება";
$_LANG['orderdomain'] = "დომეინი";
$_LANG['orderdomainoption1part1'] = "მე მსურს";
$_LANG['orderdomainoption1part2'] = "ახალი დომეინის დარეგისტრირება";
...
$_LANG['orderdomainoptions'] = "დომეინის პარამეტრები";
$_LANG['orderdomainregistration'] = "დომეინის რეგისტრაცია";
$_LANG['orderdomainregonly'] = "დომეინის რეგისტრაცია";
$_LANG['orderdomaintransfer'] = "დომეინის ტრანსფერი";
...
$_LANG['ordererrordomaininvalid'] = "მითითებული დომეინი არასწორია";
$_LANG['ordererrordomainnotld'] = "You must enter the domain TLD";
$_LANG['ordererrordomainnotregistered'] = "შეუძლებელია იმ დომეინის ტრანსფერი, რომელიც არ არის რეგისტრირებული.";
$_LANG['ordererrordomainregistered'] = "მითითებული დომეინით უკვე სხვა არის რეგისტრირებული";
$_LANG['ordererrornameserver1'] = "მიუთითეთ nameserver 1";
$_LANG['ordererrornameserver2'] = "მიუთითეთ nameserver 2";
$_LANG['ordererrornodomain'] = "თქვენ არ შეგიყვანიათ დომეინის სახელწოდება";
$_LANG['ordererrorpassword'] = "არ მიგითითებიათ პაროლი";
...
$_LANG['orderpaymentterm1month'] = "1 თვის ღირებულება";
$_LANG['orderpaymentterm24month'] = "24 თვის ღირებულება";
$_LANG['orderpaymentterm3month'] = "3 თვის ღირებულება";
$_LANG['orderpaymentterm6month'] = "6 თვის ღირებულება";
$_LANG['orderpaymenttermannually'] = "წლიურად";
$_LANG['orderpaymenttermbiennially'] = "Biennially";
$_LANG['orderpaymenttermfreeaccount'] = "უფასო ანგარიში";
$_LANG['orderpaymenttermmonthly'] = "თვიურად";
$_LANG['orderpaymenttermonetime'] = "ერთჯერადად";
...
$_LANG['promoexistingclient'] = "ამ კოდის გამოსაყენებლად საჭიროა აქტიური მომხსახურეობა/სერვისი";
$_LANG['promoonceperclient'] = "მოცემული კოდის გამოყენება მხოლოდ 1 მომხმარებელს შეუძლია";
$_LANG['pwstrengthfail'] = "მითითებული პაროლი არ არის საკმარისად ძლიერი - მოიფიქრეთ უფრო რთული პაროლი";
$_LANG['pwdoesnotmatch'] = "მითითებული პაროლები ერთმანეთს არ ემთხვევა";
$_LANG['quicknav'] = "სწრაფი ნავიგაცია";
$_LANG['recordsfound'] = "Records Found";
$_LANG['recurring'] = "მოითხოვება";
$_LANG['recurringamount'] = "მოთხოვნილი ოდენობა";
$_LANG['every'] = "ყოველი";
$_LANG['registerdomain'] = "დომეინის რეგისტრაცია";
...
$_LANG['rssfeed'] = "Feed";
$_LANG['securityanswerrequired'] = "მოითხოვება საიდუმლო კითხვის პასუხის მითითება";
...
$_LANG['serverchangepassword'] = "პაროლის შეცვლა";
...
$_LANG['supportticketspagetitle'] = "დახმარების ბილეთები";
$_LANG['supportticketsposted'] = "Posted";
$_LANG['supportticketsreply'] = "პასუხი";
$_LANG['supportticketsstaff'] = "პერსონალი";
$_LANG['supportticketsstatus'] = "სტატუსი";
$_LANG['supportticketsstatusanswered'] = "პასუხგაცემული";
$_LANG['supportticketsstatusclosed'] = "დახრული";
...
$_LANG['supportticketssubject'] = "წერილის საგანი";
...
$_LANG['supportticketsticketid'] = "ბილეთის ID";
$_LANG['supportticketsticketsubject'] = "თემა";
$_LANG['supportticketsticketsubmit'] = "დადასტურება";
$_LANG['supportticketsticketurgency'] = "Urgency";
$_LANG['supportticketsticketurgencyhigh'] = "მაღალი";
$_LANG['supportticketsticketurgencylow'] = "დაბალი";
$_LANG['supportticketsticketurgencymedium'] = "საშუალო";
$_LANG['supportticketsuploadfailed'] = "Could not upload attachment file";
$_LANG['supportticketsviewticket'] = "ბილეთის ნახვა";
...
$_LANG['hello'] = "სალამი";
$_LANG['helloname'] = "სალამი, %s!";
$_LANG['account'] = "ანგარიში";
$_LANG['login'] = "მომხმარებელი";
$_LANG['register'] = "რეგისტრაცია";
$_LANG['forgotpw'] = "დაგავიწყდათ პაროლი?";
...
$_LANG['upgradedowngradepackage'] = " პაკეტის გაზრდა/შემცირება";
...
$_LANG['copyright'] = "უფლებები";
$_LANG['allrightsreserved'] = "ყველა უფლება დაცულია";
...
$_LANG['domaincontactdetails']['Street'] = "ქუჩა";
$_LANG['domaincontactdetails']['Address 1'] = "მისამართი 1";
$_LANG['domaincontactdetails']['Address 2'] = "მისამართი 2";
$_LANG['domaincontactdetails']['Address 3'] = "მისამართი 3";
$_LANG['domaincontactdetails']['City'] = "ქალაქი";
$_LANG['domaincontactdetails']['State'] = "შტატი/რეგიონი";
$_LANG['domaincontactdetails']['County'] = "ქვეყანა";
$_LANG['domaincontactdetails']['Region'] = "რეგიონი";
$_LANG['domaincontactdetails']['Postcode'] = "საფოსტო ინდექსი";
$_LANG['domaincontactdetails']['ZIP Code'] = "ZIP კოდი";
...
$_LANG['notice'] = "შენიშნვნა";
$_LANG['networkstatussubtitle'] = "სიახლეები";

$_LANG['myaccount'] = "ჩემი ანგარიში";

$_LANG['manageproduct'] = "სერვისის მართვა";
...
$_LANG['notifications'] = "შეტყობინებები";
$_LANG['notificationsnone'] = "ამ დროისთვის, შეტყობინებები არ არის.";
...
$_LANG['orderhosting'] = "ჰოსტინგ მომსახურების დაკვეთა";
$_LANG['makepayment'] = "გადახდის გახორციელება";
$_LANG['getsupport'] = "Get Support";

$_LANG['news'] = "სიახლეები";
$_LANG['allthelatest'] = "სიახლეები შემდეგი წყაროდან";
...
$_LANG['ticketsyourhistory'] = "ბილეთების ისტორია";

$_LANG['clientareaemaildesc'] = "თქვენი ელ.ფოსტის ისტორია";

$_LANG['sslconfssl'] = "SSL მოწყობა";
...
$_LANG['ticketinfo'] = "ინფორმაცია ბილეთზე";
$_LANG['customfield'] = "დამატებითი ველები";

$_LANG['domainsActive'] = "აქტიური";
$_LANG['domainsExpired'] = "ვადაგასული";
$_LANG['domainsCancelled'] = "გაუქმებული";
...
$_LANG['cancellationrequested'] = "გაუქმება მოთხოვნილია";

$_LANG['yourrecenttickets'] = "ბოლო ბილეთები";
...
$_LANG['chooselanguage'] = "ენის არჩევა";

$_LANG['success'] = "წარმატება";
$_LANG['error'] = "შეცდომა";
$_LANG['print'] = "ამობეჭვდა";
...
$_LANG['additionalInfo'] = "დამატებითი ინფორმაცია";
$_LANG['resourceUsage'] = "რესურსების მოხმარება";
$_LANG['primaryIP'] = "ძირითადი IP";
$_LANG['assignedIPs'] = "Assigned IPs";
$_LANG['diskSpace'] = "დისკური სივრცე";
$_LANG['bandwidth'] = "ტრაფიკი";
$_LANG['registered'] = "რეგისტრირებულია";
$_LANG['upgrade'] = "პაკეტის გაუმჯობესება";

$_LANG['downdoadsdesc'] = "Manuals, programs, and other files";

$_LANG['doToday'] = "დღეს, რისი გაკეთბა გსურთ??";
...
$_LANG['renewYourDomain'] = "დომეინის ვადის გახანგრძლივება";
...
$_LANG['clientHomeSearchKb'] = "შეიყვანეთ კითხვა და მოიძიეს მასზე პასუხის ცოდნის ბაზაში...";
...
$_LANG['domaincheckertransferable'] = "ტრანსფერისთვის ხელმისაწვდომია";
...
$_LANG['domainchecker']['alreadyincartmsg'] = "ეს დომეინი უკვე კალათშია. გადადით გადახდის გვერდზე და დაასრულეთ შეკვეთა.";
$_LANG['domainchecker']['alreadyincartcheckoutnow'] = "ახლავე გადაიხადე";

$_LANG['genericerror']['title'] = "უუპს, რაღაც შეცდომა დაფიქსირდა!";
$_LANG['genericerror']['msg'] = "სცადეთ კიდევ ერთხელ, თუკი შეცდომა კვლავ დაფიქსირდა მიმართეთ ტექნიკურ განყოფილებას.";

# Licensing Addon

$_LANG['licensingaddon']['mylicenses'] = "ჩემი ლიცენზიები";
$_LANG['licensingaddon']['latestdownload'] = "ბოლო გადმოწერები";
$_LANG['licensingaddon']['downloadnow'] = "გადმოწერე ახლავე";
...
$_LANG['licensingaddon']['status'] = "ლიცენზიის სტატუსი";
...
$_LANG['cPanel']['diskUsage'] = "გამოყენებული სივრცე";
$_LANG['cPanel']['bandwidthUsage'] = "გამოყენებული ტრაფიკი";
$_LANG['cPanel']['usageStatsBwLimitNear'] = "უახლოვდებით ტრაფიკის ლიმიტს.";
$_LANG['cPanel']['usageStatsDiskLimitNear'] = "უახლოვდებით დისკური სივრცის ლიმიტს.";
...
$_LANG['cPanel']['addonDomains'] = "დამატებითი დომეინები";
...
$_LANG['cPanel']['emailAccountCreateSuccess'] = "ელ.ფოსტის ანგარიში წარმატებით შეიქმნა!";
$_LANG['cPanel']['emailAccountCreateFailed'] = "ელ.ფოსტის ანგარიში ვერ შეიქმნა: ";
...
$_LANG['showMenu'] = "მენიუს გახსნა";
$_LANG['hideMenu'] = "მენიუს დამალვა";

$_LANG['from'] = "From";
$_LANG['featuredProduct'] = "ყველაზე პოპულარული";
...
$_LANG['orderForm']['lastName'] = "გვარი";
$_LANG['orderForm']['phoneNumber'] = "ტელეფონის ნომერი";
$_LANG['orderForm']['billingAddress'] = "იურიდიული მისმართი";
$_LANG['orderForm']['companyName'] = "კომპანიის დასახელება";
$_LANG['orderForm']['optional'] = "არასავალდებულო";
$_LANG['orderForm']['streetAddress'] = "საცხოვრებლის მისამართი";
$_LANG['orderForm']['streetAddress2'] = "საცხოვრებლის მისამართი 2";
$_LANG['orderForm']['city'] = "ქალაქი";
$_LANG['orderForm']['state'] = "რეგიონი/შტატი";
$_LANG['orderForm']['country'] = "ქვეყანა";
$_LANG['orderForm']['postcode'] = "საფოსტო ინდექსი";
...
$_LANG['orderForm']['haveQuestionsContact'] = "გაქთ კითხვები? დაუკავშირდით ჩვენს ოპერატორს.";
...
$_LANG['orderForm']['priceCycle'] = "ფასი/ციკლი";
$_LANG['orderForm']['edit'] = "ჩასწორება";
$_LANG['orderForm']['update'] = "განახლება";
...
$_LANG['yourdomainplaceholder'] = 'თქვენი დომეინი';
$_LANG['yourtldplaceholder'] = 'com';

$_LANG['subaccountpermsproductsso'] = "ერთჯერადად შესვლა";
...
$_LANG['errorButTryAgain'] = "შეცდომა დაფიქსირდა. სცადეთ კიდევ ერთხელ.";
